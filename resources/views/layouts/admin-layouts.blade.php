...
<head>
    ...
    <!-- Title Page-->
    <title>Templete @yield('title')</title>
                ...
                <ul class="list-unstyled navbar__list">
                    <li class="active has-sub">
                        <a class="js-arrow" href="{{route('index')}}">
                            <i class="fas fa-tachometer-alt"></i>İndex</a>
                    ...
                    <li>
                        <a href="{{route('admin.users')}}">
                            <i class="fas fa-chart-bar"></i>Utilisateurs</a>
                    </li>
                    <li>
                        <a href="{{route('admin.uploads.img')}}">
                            <i class="fas fa-chart-bar"></i>Uploads Image</a>
                    </li>
                </ul>
            </nav>
        </div>
